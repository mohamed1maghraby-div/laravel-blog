...
<div class="widget">
    ...
    <li class="clearfix">
        <div class="widget-posts-image"><a href="#"><img src="{{ asset('user/assets/images/rp-3.jpg') }}" alt="Post Thumbnail"/></a></div>
        <div class="widget-posts-body">
    ...
    <li class="clearfix">
        <div class="widget-posts-image"><a href="#"><img src="{{ asset('user/assets/images/rp-4.jpg') }}" alt="Post Thumbnail"/></a></div>
        <div class="widget-posts-body">
